...
# Parameters to a functio are passed by refference, which is because process is
# faseter and mutable objects that are modified in functions are permanently changed.
...
# We can also use the ** construct to pass dictionaries as argumnet
def display(**details):
  for i in details:
